        ...
        <form class="form-horizontal">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="registeredNo" name="registeredNo" type="text" placeholder="Registered Number" class="form-control input-md">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="model" name="model" type="text" placeholder="Vehicle model" class="form-control input-md">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="noOfSeats" name="noOfSeats" type="number" placeholder="" class="form-control input-md">
