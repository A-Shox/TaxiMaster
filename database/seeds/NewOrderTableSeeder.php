...
class NewOrderTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        (new \App\NewOrder(['origin'=>'Pettah', 'originLatitude'=>6.934180, 'originLongitude'=>79.855608, 'destination'=>'Kadawatha', 'destinationLatitude'=>7.003807, 'destinationLongitude'=>79.954426, 'time'=>'2016-06-12 19:24:00', 'contact'=>'078748920', 'state'=>'ACCEPTED', 'taxiDriverId'=>6]))->save();
